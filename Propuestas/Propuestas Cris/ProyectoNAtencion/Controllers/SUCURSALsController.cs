...
namespace ProyectoNAtencion.Controllers
{
    public class SUCURSALsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID_SUCURSAL,ID_CLASIFICACION,ID_EMPRESA,NOMBRE_SUCURSAL,HORA_INICIO,HORA_TERMINO,UCR_SUCURSAL,UAC_SUCURSAL,UEL_SUCURSAL,FCR_SUCURSAL,FAC_SUCURSAL,FEL_SUCURSAL,LATITUD_SUCURSAL,LONGITUD_SUCURSAL")] SUCURSAL sUCURSAL)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_SUCURSAL,ID_CLASIFICACION,ID_EMPRESA,NOMBRE_SUCURSAL,HORA_INICIO,HORA_TERMINO,UCR_SUCURSAL,UAC_SUCURSAL,UEL_SUCURSAL,FCR_SUCURSAL,FAC_SUCURSAL,FEL_SUCURSAL,LATITUD_SUCURSAL,LONGITUD_SUCURSAL")] SUCURSAL sUCURSAL)
        {
            if (ModelState.IsValid)
            {
