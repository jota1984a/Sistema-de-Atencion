...
namespace Natencion.Controllers
{
    public class CLASIFICACIONsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID_CLASIFICACION,NUMERO,HORA")] CLASIFICACION cLASIFICACION)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_CLASIFICACION,NUMERO,HORA")] CLASIFICACION cLASIFICACION)
        {
            if (ModelState.IsValid)
            {
